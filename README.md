...
running command...
$ digu-cli (--version)
digu-cli/1.0.7 darwin-arm64 node-v18.15.0
...
_See code: [dist/commands/hello/index.ts](https://github.com/demarchenac/digu-cli/https://github.com/demarchenac/digu-cli/blob/v1.0.7/dist/commands/hello/index.ts)_
